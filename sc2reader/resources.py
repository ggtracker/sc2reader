...
class Replay(Resource):
    ...
    def register_default_datapacks(self):
        ...
        self.register_datapack(datapacks['WoL']['22612'], lambda r: r.expansion=='WoL' and 22612 <= r.build < 24764)
        self.register_datapack(datapacks['HotS']['24764'], lambda r: r.expansion=='WoL' and 24764 <= r.build )
